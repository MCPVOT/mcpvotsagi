...
start "DeepSeek MCP Server" cmd /k python servers\deepseek_ollama_mcp_server.py

REM Wait for DeepSeek to start
timeout /t 5 /nobreak >nul

REM Start enhanced trading agent in new window
start "DeepSeek Trading Agent" cmd /k python deepseek_trading_agent_enhanced.py
